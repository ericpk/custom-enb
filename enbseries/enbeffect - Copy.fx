...
float	ToneMappingOversaturation_ED
<
...
float	ToneMappingOversaturation_EN
<
...
float	ToneMappingCurve_ID
<
	string UIName="ToneMapping Curve Interior Day";
	string UIWidget="Spinner";
	float UIMin=0.0;
	float UIMax=10.0;
> = {1.8};

float	ToneMappingOversaturation_ID
<
	string UIName="ToneMapping Oversaturation Interior Day";
	string UIWidget="Spinner";
	float UIMin=0.1;
	float UIMax=999.0;
> = {20.0};
...
float	ToneMappingCurve_IN
<
	string UIName="ToneMapping Curve Interior Night";
	string UIWidget="Spinner";
	float UIMin=0.0;
	float UIMax=10.0;
> = {1.8};

float	ToneMappingOversaturation_IN
<
	string UIName="ToneMapping Oversaturation Interior Night";
	string UIWidget="Spinner";
	float UIMin=0.1;
	float UIMax=999.0;
> = {20.0};
...
string Param05 = "+++++DUNGEON DAY+++++";

float	AdaptationMin_DD
<
	string UIName="Adaptation Min Dungeon Day";
	string UIWidget="Spinner";
	float UIMin=0.000;
	float UIMax=1.0;
> = {0.003};

float	AdaptationMax_DD
<
	string UIName="Adaptation Max Dungeon Day";
	string UIWidget="Spinner";
	float UIMin=0.000;
	float UIMax=1.0;
> = {0.004};
...
float	Gamma_DD
<
	string UIName="Gamma Dungeon Day";
	string UIWidget="Spinner";
	float UIMin=0.0;
	float UIMax=5.0;
> = {1.1};
...
float	RedFilter_DD
<
	string UIName="Red Filter Dungeon Day";
	string UIWidget="Spinner";
	float UIStep=0.001;
	float UIMin=0.0;
	float UIMax=1.0;
...
float	GreenFilter_DD
<
	string UIName="Green Filter Dungeon Day";
	string UIWidget="Spinner";
	float UIStep=0.001;
	float UIMin=0.0;
	float UIMax=1.0;
...
float	BlueFilter_DD
<
	string UIName="Blue Filter Dungeon Day";
	string UIWidget="Spinner";
	float UIStep=0.001;
	float UIMin=0.0;
	float UIMax=1.0;
...
float	DesatR_DD
<
	string UIName="Desat Red Dungeon Day";
	string UIWidget="Spinner";
	float UIMin=0.0;
	float UIMax=1.0;
> = {1.0};
...
float	DesatG_DD
<
	string UIName="Desat Green Dungeon Day";
	string UIWidget="Spinner";
	float UIMin=0.0;
	float UIMax=1.0;
> = {0.2};
...
float	DesatB_DD
<
	string UIName="Desat Blue Dungeon Day";
	string UIWidget="Spinner";
	float UIMin=0.0;
	float UIMax=1.0;
> = {0.6};

float	IntensityContrast_DD
<
	string UIName="Intensity Contrast Dungeon Day";
	string UIWidget="Spinner";
	float UIMin=0.0;
	float UIMax=10.0;
> = {1.3};
...
float	Saturation_DD
<
	string UIName="Saturation Dungeon Day";
	string UIWidget="Spinner";
	float UIMin=0.0;
	float UIMax=10.0;
> = {1.3};

float	ToneMappingCurve_DD
<
	string UIName="ToneMapping Curve Dungeon Day";
	string UIWidget="Spinner";
	float UIMin=0.0;
	float UIMax=10.0;
> = {1.8};

float	ToneMappingOversaturation_DD
<
	string UIName="ToneMapping Oversaturation Dungeon Day";
	string UIWidget="Spinner";
	float UIMin=0.1;
	float UIMax=999.0;
> = {20.0};
...
float	Brightness_DD
<
	string UIName="Brightness Dungeon Day";
	string UIWidget="Spinner";
	float UIMin=0.0;
	float UIMax=5.0;
> = {0.15};

// Dungeon night controls
string Param06 = "+++++DUNGEON NIGHT+++++";

float	AdaptationMin_DN
<
	string UIName="Adaptation Min Dungeon Night";
	string UIWidget="Spinner";
	float UIMin=0.000;
	float UIMax=1.0;
> = {0.003};

float	AdaptationMax_DN
<
	string UIName="Adaptation Max Dungeon Night";
	string UIWidget="Spinner";
	float UIMin=0.000;
	float UIMax=1.0;
> = {0.004};
...
float	Gamma_DN
<
	string UIName="Gamma Dungeon Night";
	string UIWidget="Spinner";
	float UIMin=0.0;
	float UIMax=5.0;
> = {1.1};
...
float	RedFilter_DN
<
	string UIName="Red Filter Dungeon Night";
	string UIWidget="Spinner";
	float UIStep=0.001;
	float UIMin=0.0;
	float UIMax=1.0;
...
float	GreenFilter_DN
<
	string UIName="Green Filter Dungeon Night";
	string UIWidget="Spinner";
	float UIStep=0.001;
	float UIMin=0.0;
	float UIMax=1.0;
...
float	BlueFilter_DN
<
	string UIName="Blue Filter Dungeon Night";
	string UIWidget="Spinner";
	float UIStep=0.001;
	float UIMin=0.0;
	float UIMax=1.0;
...
float	DesatR_DN
<
	string UIName="Desat Red Dungeon Night";
	string UIWidget="Spinner";
	float UIMin=0.0;
	float UIMax=1.0;
> = {1.0};
...
float	DesatG_DN
<
	string UIName="Desat Green Dungeon Night";
	string UIWidget="Spinner";
	float UIMin=0.0;
	float UIMax=1.0;
> = {0.2};
...
float	DesatB_DN
<
	string UIName="Desat Blue Dungeon Night";
	string UIWidget="Spinner";
	float UIMin=0.0;
	float UIMax=1.0;
> = {0.6};

float	IntensityContrast_DN
<
	string UIName="Intensity Contrast Dungeon Night";
	string UIWidget="Spinner";
	float UIMin=0.0;
	float UIMax=10.0;
> = {1.3};
...
float	Saturation_DN
<
	string UIName="Saturation Dungeon Night";
	string UIWidget="Spinner";
	float UIMin=0.0;
	float UIMax=10.0;
> = {1.3};

float	ToneMappingCurve_DN
<
	string UIName="ToneMapping Curve Dungeon Night";
	string UIWidget="Spinner";
	float UIMin=0.0;
	float UIMax=10.0;
> = {1.8};

float	ToneMappingOversaturation_DN
<
	string UIName="ToneMapping Oversaturation Dungeon Night";
	string UIWidget="Spinner";
	float UIMin=0.1;
	float UIMax=999.0;
> = {20.0};
...
float	Brightness_DN
<
	string UIName="Brightness Dungeon Night";
	string UIWidget="Spinner";
	float UIMin=0.0;
	float UIMax=5.0;
> = {0.15};
...
float3 DNEIDFactor(float3 EXTDAY2, float3 EXTNIGHT2, float3 INTDAY2, float3 INTNIGHT2, float3 DUNDAY2, float3 DUNNIGHT2)
{
    if (EInteriorFactor == 1.0 && _c3.z == 1.000001) // Imagespace Brightness "hack" value
    {
        return lerp(DUNNIGHT2, DUNDAY2, ENightDayFactor);
    }
    else if (EInteriorFactor == 1.0) // 
    {
        return lerp(INTNIGHT2, INTDAY2, ENightDayFactor);
    }
    else
    {
        return lerp(EXTNIGHT2, EXTDAY2, ENightDayFactor);
    }
}
...
*/
    ...
    float Gamma=DNEIDFactor(Gamma_ED, Gamma_EN, Gamma_ID, Gamma_IN, Gamma_DD, Gamma_DN);
    float RedFilter=DNEIDFactor(RedFilter_ED, RedFilter_EN, RedFilter_ID, RedFilter_IN, RedFilter_DD, RedFilter_DN);
    float GreenFilter=DNEIDFactor(GreenFilter_ED, GreenFilter_EN, GreenFilter_ID, GreenFilter_IN, GreenFilter_DD, GreenFilter_DN);
    float BlueFilter=DNEIDFactor(BlueFilter_ED, BlueFilter_EN, BlueFilter_ID, BlueFilter_IN, BlueFilter_DD, BlueFilter_DN);
	
	float DesatR=DNEIDFactor(DesatR_ED, DesatR_EN, DesatR_ID, DesatR_IN, DesatR_DD, DesatR_DN);
	float DesatG=DNEIDFactor(DesatG_ED, DesatG_EN, DesatG_ID, DesatG_IN, DesatG_DD, DesatG_DN);
	float DesatB=DNEIDFactor(DesatB_ED, DesatB_EN, DesatB_ID, DesatB_IN, DesatB_DD, DesatB_DN);
	
	float AdaptationMin=DNEIDFactor(AdaptationMin_ED, AdaptationMin_EN, AdaptationMin_ID, AdaptationMin_IN, AdaptationMin_DD, AdaptationMin_DN);
	float AdaptationMax=DNEIDFactor(AdaptationMax_ED, AdaptationMax_EN, AdaptationMax_ID, AdaptationMax_IN, AdaptationMax_DD, AdaptationMax_DN);
	
    float Saturation=DNEIDFactor(Saturation_ED, Saturation_EN, Saturation_ID, Saturation_IN, Saturation_DD, Saturation_DN);
	float ToneMappingCurve=DNEIDFactor(ToneMappingCurve_ED, ToneMappingCurve_EN, ToneMappingCurve_ID, ToneMappingCurve_IN, ToneMappingCurve_DD, ToneMappingCurve_DN);
	float ToneMappingOversaturation=DNEIDFactor(ToneMappingOversaturation_ED, ToneMappingOversaturation_EN, ToneMappingOversaturation_ID, ToneMappingOversaturation_IN, ToneMappingOversaturation_DD, ToneMappingOversaturation_DN);
	float IntensityContrast=DNEIDFactor(IntensityContrast_ED, IntensityContrast_EN, IntensityContrast_ID, IntensityContrast_IN, IntensityContrast_DD, IntensityContrast_DN);
	float Brightness=DNEIDFactor(Brightness_ED, Brightness_EN, Brightness_ID, Brightness_IN, Brightness_DD, Brightness_DN);
